...
export function BuildTemplateDialogBody({
  ...
  return (
    <div className="flex h-full min-h-0 flex-1 flex-col">
      ...
      <div
        className="min-h-0 w-full max-h-full flex-1 touch-pan-y overflow-y-auto overflow-x-hidden overscroll-y-contain py-4 [scrollbar-gutter:stable] scroll-smooth sm:px-6 sm:py-5 px-4"
      ...
      >
        ...
        <div className="grid grid-cols-1 content-start items-start gap-3 sm:grid-cols-3 sm:gap-4">
          {templateList.map((row) => {
            const selected = buildTemplate?.slug === row.slug;
