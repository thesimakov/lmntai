...
<h2 style="margin:0 0 18px;font-size:clamp(22px,2.4vw,28px);font-weight:800">Свяжитесь с нами</h2>
...
<p style="margin:0 0 6px;font-size:11px;font-weight:700;letter-spacing:.08em;text-transform:uppercase;color:#6b7280">Контакты</p>
...
<p style="margin:0 0 10px;font-size:11px;font-weight:700;letter-spacing:.08em;text-transform:uppercase;color:#6b7280">Соцсети</p>
...
<h2 style="margin:0 0 24px;font-size:clamp(24px,2.8vw,32px);font-weight:800;line-height:1.15">Напишите нам</h2>
<form method="post" action="#" style="display:flex;flex-direction:column;gap:14px">
<input class="ct-inp ct-inp--inv" type="text" placeholder="Имя" name="name"/>
<input class="ct-inp ct-inp--inv" type="email" placeholder="Электропочта" name="email"/>
<textarea class="ct-inp ct-inp--inv" placeholder="Ваше сообщение" name="message"></textarea>
<button type="submit" style="margin-top:8px;padding:14px 24px;background:#fff;color:#1e3a5f;border:0;border-radius:8px;font-weight:800;font-size:15px;cursor:pointer;width:100%">Отправить заявку</button>
</form>
<p style="margin:16px 0 0;font-size:11px;color:rgba(255,255,255,.55);text-align:center">Нажимая кнопку, вы соглашаетесь с политикой конфиденциальности</p>
</div>
</div>
</section>`,
  },
...
<div>
<h2 style="margin:0 0 18px;font-size:clamp(22px,2.6vw,30px);font-weight:800">Свяжитесь с нами</h2>
...
<h2 style="margin:0 0 18px;font-size:clamp(20px,2.2vw,26px);font-weight:800">Напишите нам:</h2>
...
<p style="margin:0 0 22px;font-size:13px;line-height:1.65;opacity:.85">Мы на севере города. Ближайшая станция метро — «Северная дорога».</p>
...
<h2 style="margin:0 0 14px;font-size:clamp(26px,3.2vw,36px);font-weight:800">Наши контакты</h2>
<p style="margin:0;font-size:15px;line-height:1.65;color:#6b7280">Пишите, звоните и приезжайте — нам важно общение с клиентами.</p>
</div>
<div class="ct4" style="text-align:left">
<div><p style="margin:0 0 10px;font-size:15px;font-weight:800">Общие вопросы</p><p style="margin:0 0 4px;font-size:14px;color:#6b7280">+1 312 645 9870</p><p style="margin:0;font-size:14px;color:#6b7280">hello@madeontilda.com</p></div>
<div><p style="margin:0 0 10px;font-size:15px;font-weight:800">Новые проекты</p><p style="margin:0 0 4px;font-size:14px;color:#6b7280">+1 132 465 7910</p><p style="margin:0;font-size:14px;color:#6b7280">ceo@madeontilda.com</p></div>
<div><p style="margin:0 0 10px;font-size:15px;font-weight:800">Сотрудничество</p><p style="margin:0 0 4px;font-size:14px;color:#6b7280">+1 123 456 7890</p><p style="margin:0;font-size:14px;color:#6b7280">hr@madeontilda.com</p></div>
<div><p style="margin:0 0 10px;font-size:15px;font-weight:800">Как добраться</p><p style="margin:0;font-size:14px;line-height:1.55;color:#6b7280">Loft Pineapple, 22 Green Street, New York</p></div>
</div>
</section>`,
  },
  {
...
${CONTACT_CSS}
<h2 style="margin:0 0 22px;font-size:clamp(20px,2.2vw,26px);font-weight:700">Напишите нам:</h2>
...
<p style="margin:0 0 16px;font-size:15px;font-weight:700;line-height:1.5">Салон открыт ежедневно с 11:00 до 22:00.</p>
<p style="margin:0 0 28px;font-size:14px;line-height:1.65;opacity:.9">Заходите — с радостью проконсультируем по косметологии и уходу.</p>
...
<p style="margin:0 0 4px;font-size:14px;opacity:.9">Тел.: +12126789012</p>
<p style="margin:0;font-size:14px;opacity:.9">Электропочта: enquiry@lessalon.com</p>
</div>
</div>
</section>`,
  },
...
<p style="margin:0 auto 28px;max-width:520px;font-size:16px;line-height:1.6;font-weight:500">Пишите, звоните и приезжайте — нам важно<br/>общение с клиентами.</p>
...
<p style="margin:0 0 6px">Тел.: +1 123 456 78 90</p>
<p style="margin:0">Электропочта: hello@madeontilda.com</p>
</div>
</section>`,
  },
  {
...
<h3 style="margin:0 0 8px;font-size:22px;font-weight:800;line-height:1.1"><span style="color:#7ee0b0">СВЯЖИТЕСЬ</span><br/><span>С НАМИ</span></h3>
<div style="width:36px;height:2px;background:#fff;margin:14px 0"></div>
<p style="margin:0;font-size:12px;line-height:1.7;opacity:.95">Тел.: 123-456-7890<br/>Факс: 123-456-7890<br/>500 Terry Francois Street,<br/>San Francisco, CA 94158</p>
</div>
...
<h3 style="margin:0 0 8px;font-size:22px;font-weight:800;line-height:1.1"><span style="color:#7ee0b0">ПРИЕЗЖАЙТЕ</span><br/><span>К НАМ</span></h3>
<div style="width:36px;height:2px;background:#fff;margin:14px 0"></div>
<p style="margin:0;font-size:12px;line-height:1.7;opacity:.95">Пн–пт: 11:00–18:30<br/>Сб: 11:00–17:30<br/>Вс: 12:30–16:30</p>
</div>
<div style="background:#7dd3c0;color:#111;padding:24px 16px;display:flex;flex-direction:column;justify-content:center">
<h3 style="margin:0 0 8px;font-size:22px;font-weight:800;text-align:center;line-height:1.1"><span>НАПИШИТЕ</span><br/><span style="color:#fff">НАМ</span></h3>
...
<button type="button" style="margin-top:12px;margin-left:auto;padding:8px 20px;background:#111;color:#fff;border:0;font-weight:700;cursor:pointer;font-size:12px">ОК</button>
</div>
</div>
</section>`,
  },
...
<div style="display:grid;grid-template-columns:1fr 1fr;gap:10px;margin-bottom:10px"><input class="ct-inp" placeholder="Имя"/><input class="ct-inp" placeholder="Электропочта"/></div>
...
${CONTACT_CSS}
<h2 style="margin:0 0 16px;font-size:clamp(28px,3.2vw,38px);font-weight:800">Контакты</h2>
<p style="margin:0 auto 36px;max-width:520px;font-size:15px;line-height:1.65;color:#6b7280">Если есть вопросы, свяжитесь по телефону или почте. Также можно получить заказ по указанному адресу.</p>
<div style="font-family:Georgia,serif;font-size:16px;line-height:1.7">
<p style="margin:0 0 6px">New York, Loft Pie, 22 Pink Street</p>
<p style="margin:0 0 6px">Тел.: +1 123 456 7890</p>
<p style="margin:0">Электропочта: hello@madeontilda.com</p>
</div>
</section>`,
  },
...
<p style="margin:0 auto 24px;font-size:14px;color:#475569">info@mysite.com | Тел.: 123-456-7890</p>
<div style="display:flex;gap:10px;justify-content:center;margin-bottom:28px">
...
<input class="ct-inp" name="email" type="email" placeholder="Электропочта"/>
...
<p style="margin:0 0 14px;font-size:12px;font-weight:800;letter-spacing:.12em">ЧАСЫ РАБОТЫ</p>
<p style="margin:0;font-size:11px;line-height:1.8;opacity:.95">ПН–ПТ: 11.00–19.30<br/>СБ: 11.00–17.00<br/>ВС: 12.30–16.30</p>
</div>
...
<p style="margin:0 0 14px;font-size:12px;font-weight:800;letter-spacing:.12em">АДРЕС</p>
<p style="margin:0;font-size:11px;line-height:1.8;font-weight:600">500 TERRY FRANCOIS STREET<br/>SAN FRANCISCO, CA 94158<br/>INFO@MYSITE.COM | ТЕЛ.: 123-456-7890</p>
</div>
...
<p style="margin:0;font-size:15px;font-style:italic;color:#9ca3af">Будем рады вашему сообщению</p>
</div>
...
<p style="margin:0;font-size:13px;font-weight:600">Мы в Facebook</p>
</div>
</div>
</section>`,
  },
...
<p style="margin:0 0 24px;font-size:13px;line-height:1.6;color:#4b5563;max-width:320px">2030 Terry Francois Street, San Francisco, CA 94158<br/>info@mysite.com / Тел.: 123-456-7890</p>
...
<div><div style="width:52px;height:52px;margin:0 auto 12px;border-radius:12px;background:#f1f5f9;display:flex;align-items:center;justify-content:center;font-size:20px">✉</div><p style="margin:0 0 4px;font-size:12px;font-weight:800;letter-spacing:.06em;color:#64748b">ЭЛ. ПОЧТА</p><p style="margin:0;font-size:15px;font-weight:700">hello@madeontilda.com</p></div>
